    ...
    <section id="clients" className="py-24 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-gray-500 text-base">
            From emerging startups to Fortune 500 enterprises — our clients
            rely on us to deliver exceptional creative work, every time.
          </motion.p>
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 text-center">
        <p className="text-gray-400 text-sm">
          Join{" "}
          <span className="font-semibold text-[#58C4F6]">120+ satisfied clients</span>{" "}
          who chose Printo Press for their creative needs
        </p>
      </div>
    </section>
  );
